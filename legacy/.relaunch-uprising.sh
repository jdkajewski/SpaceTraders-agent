...
GATE_SUPPLY=1 GATE_HAULERS=18 GATE_CREDIT_FLOOR=900000 GATE_CREDIT_RESUME=1500000 GATE_MAX_SUPPLIERS=3 GATE_PROTECT=1 GATE_MAX_PRICE="FAB_MATS:1700,ADVANCED_CIRCUITRY:6000" \
GATE_FUEL_CARGO=1 FUEL_CARGO=1 \
INPUT_FEED=1 \
FEED_FOCUS_MATERIALS=FAB_MATS FEED_MAX_LOSS_PER_UNIT=30 FEED_RESERVE_INPUTS=1 \
