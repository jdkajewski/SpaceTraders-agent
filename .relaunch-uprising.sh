...
REPAIR=1 \
AUTO_EXPAND=1 EXPAND_TARGET_SYSTEM=X1-YK2 EXPAND_OUTPOSTS=X1-JH56,X1-YS20,X1-ZV87,X1-CM31,X1-ZD86,X1-DM89,X1-CK76 EXPAND_RECALL=0 EXPAND_RECALL_RELEASE=1500000 EXPAND_CREDIT_FLOOR=300000 EXPAND_AUTOBUY=1 EXPAND_BUY_FLOOR=1500000 \
  EXPAND_MAX_BUY_TRADERS=40 EXPAND_MAX_BUY_PROBES=120 EXPAND_OUTPOST_PROBES=4 EXPAND_OUTPOST_TRADERS=4 \
  EXPAND_TRADERS_PER_SYS=X1-ZV87:7,X1-JH56:6,X1-YK2:6,X1-YS20:1,X1-DB23:4 \
  EXPAND_MAX_PROBE_PRICE=50000 EXPAND_MAX_TRADER_PRICE=400000 \
  EXPAND_MINE=X1-ZV87,X1-CM31,X1-ZD86 EXPAND_MINE_SURVEYORS=1 EXPAND_MINE_HAULERS=2 EXPAND_MINE_DRONES=6 EXPAND_MAX_BUY_DRONES=40 \
  EXPAND_AUTOBUY_MS=12000 \
  EXPAND_SCAN_TTL_MS=240000 \
  CHAIN_FEED=1 FEEDER_SHIPS=UPRISING-8F FEED_PREFER_MINED=1 FEED_MIN_MARGIN_PCT=25 FEED_SATURATION_N=2 \
DEBUG_CONTRACT=0 \
