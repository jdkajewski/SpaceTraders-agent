...
REPAIR=1 \
AUTO_EXPAND=1 EXPAND_TARGET_SYSTEM=X1-YK2 EXPAND_OUTPOSTS=X1-JH56,X1-YS20,X1-ZV87 EXPAND_RECALL=0 EXPAND_RECALL_RELEASE=1500000 EXPAND_CREDIT_FLOOR=300000 EXPAND_AUTOBUY=1 EXPAND_BUY_FLOOR=1500000 \
  ...
  EXPAND_MINE=X1-ZV87 EXPAND_MINE_SURVEYORS=1 EXPAND_MINE_HAULERS=2 EXPAND_MINE_DRONES=6 EXPAND_MAX_BUY_DRONES=40 \
